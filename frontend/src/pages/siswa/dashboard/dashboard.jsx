  ...
  useEffect(() => {
    const fetchDashboard = async () => {
      try {
        ...
        const res = await apiClient.get(`/api/dashboard/siswa?hari=${hariIni}`);
          ...
          <div className="db-grid">
                ...
                <div className="db-hero-body">
                  <div className="db-hero-avatar">
                    <img
                      ...
                      src={avatarUrl}
                      onError={(e) => {
                        e.target.src = AVATAR_HERO;
                      }}
                    />
                  </div>
                  <div className="db-hero-info">
                    <span className="db-badge">Profil Siswa</span>
                    <h2 className="db-hero-name">
                      Halo, {user?.nama || "Siswa"}
                    </h2>
                    <p className="db-hero-sub">
                      {user?.role || "S1 Informatika"}
                    </p>
                  </div>
                    ...
                    >
                      <div className="db-progress-row">
                        <div>
                          ...
                          <p className="db-progress-sub">
                            {dashboardData.progress.tugasSelesai} dari{" "}
                            {dashboardData.progress.totalTugas} tugas selesai
                          </p>
                        </div>
                        <p
                      ...
                      <div className="db-bar-track">
                        <div
                          ...
                          style={{
                            width: `${dashboardData.progress.persentase}%`,
            ...
            <div className="db-right">
              ...
              <div className="db-presensi-card">
                ...
                <p>
                  Pindai kode QR yang diberikan guru untuk mencatat kehadiran
                  Anda di kelas.
                </p>
                <button
                  className="db-scan-btn"
                  onClick={() => onNavigate && onNavigate("presensiSiswa")}
                >
              ...
              {loading ? (
                ...
                >
                  <div className="db-class-img">
                    ...
                    <span className="db-class-badge">
                      Mata Pelajaran Aktif ({dashboardData.mataKuliah.length})
                    </span>
                  </div>
                  <div className="db-class-body">
                    <div className="db-info-item">
                      ...
                      <div>
                        ...
                        >
                          {dashboardData.mataKuliah[0]?.guruNama || "Guru"}
