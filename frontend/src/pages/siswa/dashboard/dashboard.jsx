...
export default function Dashboard({ onNavigate, onLogout }) {
  ...
  return (
    <div className="page-shell">
      ...
      <main className="page-main">
        {/* Navbar */}
        <Navbar role="Siswa" onOpenSidebar={() => setSidebarOpen(true)} onNavigate={typeof nav !== "undefined" ? nav : (typeof onNavigate !== "undefined" ? onNavigate : undefined)} />
              ...
              >
                ...
                <div className="db-hero-body">
                  ...
                  <div className="db-hero-info">
                    ...
                    <h2 className="db-hero-name">Halo, {user?.nama || "Siswa"}</h2>
