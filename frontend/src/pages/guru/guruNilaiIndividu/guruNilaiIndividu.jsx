...
export default function GuruNilaiIndividu({
  ...
  useEffect(() => {
    if (selectedTugas) fetchSiswaList();
  }, [selectedTugas]);
    ...
    >
            ...
            <div className="dni-modal-body">
              <div className="dni-student-info">
                ...
                <div>
                  ...
                  <p className="dni-student-nis">{nilaiModal.nomorInduk}</p>
                </div>
              </div>
      ...
      >
        ...
        <div className="page-content">
          <div className="dni-header">
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginTop: "0.5rem" }}>
                ...
                <button onClick={clearClass} className="dni-btn-cancel" style={{ display: "inline-flex", alignItems: "center", gap: "0.375rem", padding: "0.375rem 0.75rem", border: "1px solid var(--color-border)", borderRadius: "20px", fontSize: "0.85rem", fontWeight: "600", cursor: "pointer", transition: "all 0.2s" }}>
          ...
          {/* Filter tabs */}
          {selectedTugas && siswaList.length > 0 && (
                      ...
                      <td>
                        <div className="dni-student-cell">
                          ...
                          <div>
                            ...
                            <p className="dni-nis">{m.nomorInduk}</p>
                          </div>
                        </div>
                      </td>
                      <td>
