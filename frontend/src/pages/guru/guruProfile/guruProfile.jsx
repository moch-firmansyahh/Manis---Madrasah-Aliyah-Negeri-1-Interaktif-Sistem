...
import "../../siswa/profile/profile.css";
...
export default function GuruProfile({ onNavigate, onLogout }) {
    ...
    const fetchProfile = async () => {
      try {
        ...
        if (res && res.data) {
          const d = res.data;
          setProfileData({
            nama: d.nama || storedUser.nama || "Guru",
          ...
          <div className="prf-identity-card dprf-identity-card">
            ...
            <div className="prf-identity-info">
              ...
              <div className="prf-identity-meta">
                <span className="prf-nis-badge dprf-nidn-badge">
